...
def update_physcis_maneger(delay, quadcopterId, quadcopter_controller):
    ...
    update_physics(delay, quadcopterId, quadcopter_controller, cmd_sub, imu_pub, range_pub)
    
def update_physics(delay,quadcopterId,quadcopter_controller, cmd_sub, imu_pub, range_pub):
...
thread_physics = Thread(target=update_physcis_maneger,args=(Tsample_physics,quadcopterId,qcc))
# start the thread:
